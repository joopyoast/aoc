...
final class Puzzle4Test extends TestCase {
	...
	public function testSquidBingo() {
		$boards = [
			new Board( [
				[
					new Number( 22 ),
		...
		$drawings = explode( ',', '7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1' );

		foreach ( $drawings as $draw ) {
			$game->draw( (int)$draw );
		}
		self::assertSame( 1924, $game->getLastDrawnNumber() * $game->winningBoard()->score() );
